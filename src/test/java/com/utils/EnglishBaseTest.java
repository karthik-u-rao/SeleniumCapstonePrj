...
/**
 * Base test that forces Chrome to use English (en-US) UI regardless of OS locale.
 * This ensures OrangeHRM loads in English consistently.
 */
public class EnglishBaseTest {
